(() => {
    ...
    class Popup {
        constructor(options) {
            let config = {
                ...
                classes: {
                    popup: "main-block__popup",
                    popupContent: "popup-main__content",
    ...
    function initSliders() {
        if (document.querySelector(".vacation__slider")) new core(".vacation__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: "auto",
            ...
            loop: true,
            navigation: {
                prevEl: ".vacation__slider .slider-arrow_prev",
                nextEl: ".vacation__slider .slider-arrow_next"
            },
            on: {}
        });
        if (document.querySelector(".investment__slider")) new core(".investment__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2,
            ...
            loop: true,
            navigation: {
                prevEl: ".investment__content .slider-arrow_prev",
                nextEl: ".investment__content .slider-arrow_next"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1,
